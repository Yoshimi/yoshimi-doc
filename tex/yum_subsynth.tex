...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.45]{2.3.5/sub.png}
...
\label{subsec:subsynth_amplitude}
   ...
   \itempar{Amplitude LFO}{subsynth!amplitude LFO}
   Amplitude LFO.
...
\label{subsec:subsynth_frequency}
   ...
   \itempar{Frequency LFO}{subsynth!freq lfo}
   Frequency LFO Stock Sub-Panel.
   See \sectionref{subsubsec:lfo_user_interface_panels}, for more details.
...
\label{subsec:subsynth_filter}
   ...
   \itempar{Filter LFO}{subsynth!filter LFO}
   See \sectionref{subsubsec:lfo_user_interface_panels},
   which describes this stock sub-panel.
