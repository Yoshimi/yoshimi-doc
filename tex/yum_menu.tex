...
\label{subsec:menu_yoshimi}
   ...
   \begin{figure}[H]
   \centering
   \includegraphics[scale=0.9]{2.0/Menu.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.7]{2.3.5/menu_yoshimi.png}
   \caption[Yoshimi Menu, Exit]{Yoshimi Menu}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.5]{2.3.5/about.png}
...
%  back all the settings that were previously used for that instance.
   ...
   In the other instances these are hidden rather than deactivated.  This
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.4]{2.3.5/switches.png}
...
\end{figure}
   ...
   \index{new!Enable Part Reports}
   \itempar{Enable Part Reports}{Main Settings!Enable Part Reports}
   ...
   2 9 19 have all been edited. If one attempts to shut \textsl{Yoshimi} down it will display the
   following warning:

   \begin{figure}[H]
   \centering
   \includegraphics[scale=0.5]{2.3.5/instrument_changed}
   \caption{Yoshimi Instrument Changed}
   \label{fig:yoshimi_instrument_changed}
\end{figure}

   \itempar{Hide Non-essential Reports}{Main Settings!Hide Non-essential Reports}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.4]{2.3.3/midi.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.4]{2.3.3/midi_cc_pending.png}
