%-------------------------------------------------------------------------------
% yoshimi-advanced-reference-manual
%-------------------------------------------------------------------------------
%
% \file        yoshimi-advanced-reference-manual.tex
% \library     Documents
...
\chead{}
\rhead{Advanced Reference Manual}
\lfoot{}
\cfoot{\thepage}
\rfoot{}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.60]{2.3.5/main.png}
\end{figure}
\vfill
...
\label{subsubsec:new_features_resizable_windows}
   ...
   Full details can be found in \sectionref{sec:revised_interface}
...
\label{subsubsec:new_features_accessibility}
   ...
   and very much likes vector control.  So accessibility \index{accessibility}
...
\index{new!Yoshimi/ZynAddSubFX Warning}
...
%  in \figureref{fig:compatibility_warning}.
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=1.0]{2.3.0/compatibilitywarning.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.75]{2.3.3/splash.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=1.0]{2.3.0/firsttime.png}
...
%
% It causes issues, and is a short section anyway.
%
