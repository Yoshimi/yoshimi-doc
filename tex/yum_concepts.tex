...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.50]{zyn/zyn-diagram.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.35]{zyn/zyn-synth.png}
...
\label{subsec:concepts_instances}
   ...
   A final note... copy-and-paste can indirectly work across instances.
   One can copy from the main instance's AddSynth part 3 to the clipboard,
   then paste the clipboard entry to instance 3's kit item 6 AddSynth.
